...
const long hitRelease = 50;   // release time afert hit in ms
...
int potiRaw = 0;
float potiVolt = 0; //0.43 is okay
float lastPoti = 0;

const float changeThresh = 0.03;
...
void loop() {
  ...
  if (sensVolt > potiVolt &&  (now - lastHit) > hitRelease ) {
